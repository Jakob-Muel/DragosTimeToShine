...
func _init() -> void:
	...
	assert(catalog.egg_candidates(&"ice") == [&"frost"], "Frosteros must remain preserved in the catalog.")
	...
	assert(frost.flight_texture_path.ends_with("frost_flight.png"), "Frosteros needs its own flight sprite.")
	...
	assert(ember.island_texture_path.ends_with("universal_island.png"), "Ember uses the shared island.")
	...
	assert(marina.island_texture_path.ends_with("universal_island.png"), "Marina uses the shared island.")
	...
	assert(terra.island_texture_path.ends_with("universal_island.png"), "Terra uses the shared island.")
	...
	assert(voltara.island_texture_path.ends_with("universal_island.png"), "Voltara uses the shared island.")
	...
	assert(lavara.island_texture_path.ends_with("universal_island.png"), "Lavara uses the shared island.")
	...
	assert(mudara.island_texture_path.ends_with("universal_island.png"), "Mudara uses the shared island.")
	...
	assert(frost_egg == &"frost", "The ice egg pool must offer the unowned Frosteros definition.")
	assert(
