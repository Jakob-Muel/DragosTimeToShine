...
- [Produktanforderungen und Implementierungsplan](DRAGO_PRODUKTANFORDERUNGEN_UND_IMPLEMENTIERUNGSPLAN.html): unveränderte Kopie des vom Nutzer bereitgestellten „DraGO – Gesamtbericht und Implementierungsplan“, ohne Aufwandsschätzung. Übernommen am 22.09.2026 aus `DraGO-Gesamtbericht-ohne-Aufwand 2.html`.
- [Soll-Ist-Abgleich und nächste Schritte](SOLL_IST_ABGLEICH.md): Bewertung des aktuellen Godot-Prototyps gegenüber dem Bericht.
